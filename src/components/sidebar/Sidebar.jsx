  ...
  return (
    <div className='sidebar'>
      ...
      <p style={{ color: 'black', fontWeight: 'bold' }} className='gmail'>
        <a
          href='https://mail.google.com/mail/u/0/#sent?compose=jrjtXRHftXDQHLsWHDQdTzCmQwDrbCpHQKTpWjQfXqbGflZnghjDlJvBGxmFmmkkPFdNmPMW&projector=1'
          rel='opener noreferrer'
          target='_blank'
          className='fa fa-envelope'
        ></a>
        &nbsp;virajnagar890@gmail.com
      </p>
